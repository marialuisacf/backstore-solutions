...
public class FacturaDAOTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            String tipoSeguro = socio instanceof Estandar ? ((Estandar) socio).getSeguro().getTipo() : null;
            double precioSeguro = socio instanceof Estandar ? ((Estandar) socio).getSeguro().getPrecio() : 0.0;
            Inscripcion inscripcion = new Inscripcion("INS001", socio, excursion, java.sql.Date.valueOf("2024-12-01").toLocalDate(), tipoSeguro, precioSeguro);
            ...
            Factura factura = new Factura(socio, java.sql.Date.valueOf("2024-12-01").toLocalDate(), 50.0, 10.0, 60.0);
